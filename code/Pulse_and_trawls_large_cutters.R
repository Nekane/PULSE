##################################################################################
# PULSE TRAWL PROJECT
# Code for Pulse and Beam with 100 mm large trawls and euro cutters independent scenarios
# 8 October 2018
# IJmuiden- IMARES
##################################################################################
...
# ---------------------
# ---------------------------------------------
# PULSE AND BEAM TRAWLS: LONG DISTANCE fleet
# --------------------------------------------
# ---------------------
...
# pulse trawls
sp1p<- sp2p <- sp3p <-   new("DynStateInput")
sp1p <- cpue_dsvm_sp(sol_pulse_large.csv, sp1, 1.637352)  #SOLE   # gamsol$family$getTheta() for Sole in Jurgens GAMs is 1.637352
sp2p <- cpue_dsvm_sp(ple_pulse_large.csv, sp2, 1.195788)  #PLAICE # gample$family$getTheta() for Plaice in Jurgens GAMs is 1.195788
sp3p <- cpue_dsvm_sp(cod_pulse_large.csv, sp3, 0.8979249) #COD    # gamcod$family$getTheta() for Cod in Jurgens GAMs is 0.8979249

# I combine in one object cpue for pulse in areas 1,2,3,4,5,6,7,8,10,11 and 13 with beam 100 mm in areas 9,12,14,16
catchMean(sp1)[,,c(1:8,10:11,13)] <- catchMean(sp1p)[,,c(1:8,10:11,13)]
catchMean(sp2)[,,c(1:8,10:11,13)] <- catchMean(sp2p)[,,c(1:8,10:11,13)]
catchMean(sp3)[,,c(1:8,10:11,13)] <- catchMean(sp3p)[,,c(1:8,10:11,13)]
...
#-------------------------------------------------------------------------------------
# Fuleprice for pulse 1380/4, however for beams in area 9,12,14 and 16 is 2320/4=580......................NEED TO FIX THIS!!!!
control     <- DynState.control(spp1LndQuota= 160e3,  spp2LndQuota=100e9, spp1LndQuotaFine= 320, spp2LndQuotaFine= 3e6, fuelUse = 1, fuelPrice = 345, landingCosts= 0.24,gearMaintenance= 87, addNoFishing= TRUE, increments= 20, spp1DiscardSteps= 0, spp2DiscardSteps= 0, sigma= 1.5e+04, simNumber= 1000 , numThreads= 40, verbose=1)


BS160 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_large_B160_south_sigma_1_5e4.RData")
...
save.image("~/modelresults/Pulse_large_B120_south_sigma_1_5e4.RData")
...
save.image("~/modelresults/Pulse_large_B80_south_sigma_1_5e4.RData")

save(list=c("BS160","BS120","BS80"), file="~/modelresults/Pulse_large_south_B160_80_south_sigma_1_5e4.RData.RData")
...
save.image("~/modelresults/Pulse_large_B160_north_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(120e3)
BN120 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_large_B120_north_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(80e3)
BN80 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_large_B80_north_sigma_1_5e4.RData")

save(list=c("BN160","BN120","BN80"), file="~/modelresults/Pulse_large_north_B160_80_sigma_1_5e4.RData")
...
# Fuleprice for pulse 590/4, however for beams in area 9,12,14 and 16 is 648/4=162......................NEED TO FIX THIS!!!!
control     <- DynState.control(spp1LndQuota= 160e3,  spp2LndQuota=100e9, spp1LndQuotaFine= 320, spp2LndQuotaFine= 3e6, fuelUse = 1, fuelPrice = 148, landingCosts= 0.24,gearMaintenance= 87, addNoFishing= TRUE, increments= 20, spp1DiscardSteps= 0, spp2DiscardSteps= 0, sigma= 1.5e+04, simNumber= 1000 , numThreads= 40, verbose=1)
 
CS160 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_small_C160_south_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(120e3)
CS120 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_small_C120_south_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(80e3)
CS80 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_small_C80_south_sigma_1_5e4.RData")

save(list=c("CS160","CS120","CS80"), file="~/modelresults/Pulse_small_south_C160_80_sigma_1_5e4.RData")
...
save.image("~/modelresults/Pulse_small_B160_north_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(120e3)
CN120 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_small_B120_north_sigma_1_5e4.RData")

control@spp1LndQuota <- as.numeric(80e3)
CN80 <- DynState(sp1, sp2, sp3, sp4, sp5, sp1Price, sp2Price, sp3Price, sp4Price, sp5Price, effort, control)
save.image("~/modelresults/Pulse_small_B80_north.RData")

save(list=c("CN160","CN120","CN80"), file="~/modelresults/Pulse_small_north_C160_80_sigma_1_5e4.RData")
